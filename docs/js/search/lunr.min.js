...
!function () {
  ...
  e.version = "2.3.9",
    ...
    e.FieldRef.prototype.toString = function () {
      return void 0 == this._stringValue &&
    ...
    e.Index.prototype.query = function (t) {
      ...
      for (var u = 0; u < r.clauses.length; u++) {
        var l = r.clauses[u], c = null, h = e.Set.empty;
        c = l.usePipeline
        ...
        for (var d = 0; d < c.length; d++) {
          ...
          for (var g = 0; g < y.length; g++) {
            for (
              ...
              } else {void 0 === a[v] && (a[v] = e.Set.empty),
                  a[v] = a[v].union(L);}
            }
          }
        }
      ...
      if (r.isNegated()) {
        ...
        for (var u = 0; u < C.length; u++) {
          var O = C[u], j = e.FieldRef.fromString(O);
          i[O] = new e.MatchData();
        }
      }
      for (var u = 0; u < C.length; u++) {
        var j = e.FieldRef.fromString(C[u]), D = j.docRef;
    ...
    e.Index.load = function (t) {
      ...
      for (var l = 0; l < n.length; l++) {
        var c = n[l], h = c[0], d = c[1];
        i[h] = new e.Vector(d);
      }
      for (var l = 0; l < o.length; l++) {
        var c = o[l], f = c[0], p = c[1];
        a.insert(f), s[f] = p;
      }
      return a.finish(),
        r.fields = t.fields,
    ...
    e.QueryLexer.prototype.acceptDigitRun = function () {
      var t, r;
      do t = this.next(), r = t.charCodeAt(0); while (r > 47 && r < 58);
