...
!function (t, e) {
  ...
  var e = new WeakMap(),
    ...
    i = void 0 !== window.customElements &&
  ...
  var u = function u(t, e) {
    ...
    var n = [],
      o = function o(e) {
        var r = e.content, a = document.createTreeWalker(r, 133, null, !1);
        var h = 0;
        for (; a.nextNode();) {
          s++;
          ...
          for (; s < e.length && null !== r;) {
            ...
            if (p(_t8)) {
              if (n === _t8.index) {
                ...
                } else {(_this2$_parts = _this2._parts).push.apply(
                    _this2$_parts,
                    _toConsumableArray(
  ...
  var x = function (_f) {
    ...
    _createClass(x, [{
      ...
      key: "getTemplateElement",
      value: function getTemplateElement() {
        var t = _get(_getPrototypeOf(x.prototype), "getTemplateElement", this)
            .call(this),
          e = t.content,
          s = e.firstChild;
  ...
  var y = function () {
    ...
    _createClass(y, [{
      ...
      value: function _getValue() {
        var t = this.strings, e = t.length - 1;
        var s = "";
  ...
  var S = function () {
    ...
    _createClass(S, [{
      ...
      value: function handleAttributeExpressions(t, e, s, i) {
        var n = e[0];
        if ("." === n) return new w(t, e.slice(1), s).parts;
        return "@" === n
