...
}(
  {
      ...
      e.exports = {
        enable: function (t) {
          ...
          n.setAttribute("id", "svg-pan-zoom-controls"),
            n.setAttribute(
              "transform",
              "translate(" + (t.width - 70) + " " + (t.height - 76) +
                ") scale(0.75)",
            ),
    ...
    2: [function (t, e, o) {
      ...
      n.prototype.init = function (t, e) {
        ...
        n.prototype.processCTM = function () {
          var t, e = this.getCTM();
          (this.options.fit || this.options.contain) && (t = this.options.fit
            ? Math.min(
              this.options.width / this.viewBox.width,
              this.options.height / this.viewBox.height,
            )
          ...
          if (e || o) {
            if (
              ...
              (!1 ===
                ...
                : (this.updateCache(t),
                  this.options.onZoom(this.getRelativeZoom()))), o
            ) {
    ...
    4: [function (t, e, o) {
      ...
      i.prototype.init = function (t, e) {
        ...
        i.prototype.handleMouseWheel = function (t) {
          if (this.options.zoomEnabled && "none" === this.state) {
            ...
            var e = t.deltaY || 1,
              ...
              n = 3 + Math.max(0, 30 - o);
            this.lastMouseWheelEventTime = Date.now(),
              "deltaMode" in t && 0 === t.deltaMode && t.wheelDelta &&
        ...
        i.prototype.zoomAtPoint = function (t, e, o) {
          ...
          var i = this.viewport.getCTM(),
            ...
            r = this.svg.createSVGMatrix().translate(s.x, s.y).scale(t)
              .translate(-s.x, -s.y),
            a = i.multiply(r);
        ...
        i.prototype.handleDblClick = function (t) {
          ...
          var o = a.getEventPoint(t, this.svg).matrixTransform(
          ...
          (t.preventDefault ? t.preventDefault() : t.returnValue = !1),
            ...
            this.options.dblClickZoomEnabled && r.isDblClick(t, e)
              ...
              : (this.state = "pan",
                ...
                this.stateOrigin = a.getEventPoint(t, this.svg).matrixTransform(
        ...
        i.prototype.handleMouseMove = function (t) {
          if (
            ...
            var e = a.getEventPoint(t, this.svg).matrixTransform(
                this.firstEventCTM.inverse(),
              ),
        ...
        i.prototype.getPublicInstance = function () {
          ...
          return this.publicInstance || (this.publicInstance = this.pi = {
            ...
            setBeforePan: function (t) {
              return o.options.beforePan = null === t
                ? null
                : r.proxy(t, o.publicInstance),
                o.pi;
            },
            setOnPan: function (t) {
              return o.options.onPan = null === t
                ? null
                : r.proxy(t, o.publicInstance),
                o.pi;
            },
            ...
            setBeforeZoom: function (t) {
              return o.options.beforeZoom = null === t
                ? null
                : r.proxy(t, o.publicInstance),
                o.pi;
            },
            setOnZoom: function (t) {
              return o.options.onZoom = null === t
                ? null
                : r.proxy(t, o.publicInstance),
                o.pi;
            },
            ...
            zoomOut: function () {
              return this.zoomBy(1 / (1 + o.options.zoomScaleSensitivity)),
                o.pi;
            },
            getZoom: function () {
            ...
            setOnUpdatedCTM: function (t) {
              return o.options.onUpdatedCTM = null === t
                ? null
                : r.proxy(t, o.publicInstance),
                o.pi;
            },
      ...
      e.exports = function (t, e) {
        ...
        return c.push({ svg: o, instance: new i(o, e) }),
        ...
        e.exports = {
          ...
          getOrCreateViewport: function (t, e) {
            ...
            if (!(o = l.isElement(e) ? e : t.querySelector(e))) {
              var n = Array.prototype.slice.call(t.childNodes || t.children)
                .filter(function (t) {
                  return "defs" !== t.nodeName && "#text" !== t.nodeName;
                });
              1 === n.length && "g" === n[0].nodeName &&
                null === n[0].getAttribute("transform") && (o = n[0]);
            }
            if (!o) {
              var i = "viewport-" +
          ...
          getEventPoint: function (t, e) {
            ...
            return l.mouseAndTouchNormalize(t, e),
              o.x = t.clientX,
              o.y = t.clientY,
              o;
          },
    ...
    6: [function (t, e, o) {
      function n(t, e, o, n) {
        ...
        i = "wheel" === a ? o : function (t, o) {
          function e(t) {
            ...
            return "mousewheel" == a
              ? (e.deltaY = -.025 * t.wheelDelta,
                t.wheelDeltaX && (e.deltaX = -.025 * t.wheelDeltaX))
              : e.deltaY = t.detail,
              o(e);
          }
      ...
      e.exports = (u = [],
        ...
        a = "onwheel" in document.createElement("div")
          ? "wheel"
      ...
      e.exports = {
        ...
        isElement: function (t) {
          return t instanceof HTMLElement || t instanceof SVGElement ||
            ...
            t && "object" == typeof t && null !== t && 1 === t.nodeType &&
        ...
        getType: function (t) {
          return Object.prototype.toString.apply(t).replace(/^\[object\s/, "")
            .replace(/\]$/, "");
        },
        ...
        createRequestAnimationFrame: function (t) {
          var e = null;
          return "auto" !== t && t < 60 && 1 < t && (e = Math.floor(1e3 / t)),
