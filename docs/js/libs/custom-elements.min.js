(function () {
  ...
  v.prototype.attributeChangedCallback = function (b, a, c, d, e) {
    ...
    f.attributeChangedCallback && -1 < f.observedAttributes.indexOf(a) &&
  ...
  function va() {
    ...
    window.HTMLElement = function () {
      function a() {
        var a = this.constructor, d = b.s.get(a);
        if (!d) {
          throw Error(
        ...
        if (!e.length) {
          return e = H.call(document, d.localName),
  ...
  function xa() {
      ...
      Object.defineProperty(a, "textContent", {
        ...
        set: function (a) {
          if (this.nodeType === Node.TEXT_NODE) d.set.call(this, a);
            ...
            var e = void 0;
            if (this.firstChild) {
              var c = this.childNodes, k = c.length;
              if (0 < k && n(this)) {
    ...
    u(Node.prototype, "replaceChild", function (a, d) {
      ...
      var e = n(a), f = N.call(this, a, d), c = n(this);
      c && B(b, d);
      e && B(b, a);
      c && z(b, a);
      return f;
  ...
  */
  ...
  if (
    !Z || Z.forcePolyfill || "function" != typeof Z.define ||
