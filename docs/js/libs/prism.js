      ...
      for (
        ...
        if ("keyword" === a.type && "mutation" === a.content) {
          ...
          if (
            ...
            for (var u = e; u < s; u++) {
              var p = t[u];
              "variable" === p.type && r.indexOf(p.content) >= 0 &&
                b(p, "variable-input");
            }
          }
        }
...
!function (e) {
  ...
  e.languages.insertBefore("ruby", "keyword", {
    ...
    symbol: [{ pattern: RegExp("(^|[^:]):" + i), lookbehind: !0, greedy: !0 }, {
      pattern: RegExp("([\r\n{(,][ \t]*)" + i + "(?=:(?!:))"),
      lookbehind: !0,
      greedy: !0,
    }],
      ...
      Prism.hooks.add("complete", function (t) {
        if (t.code) {
          ...
          if (
            ...
            !i.querySelector(".line-numbers-rows") && Prism.util.isActive(i, e)
          ) {
            ...
            (l = document.createElement("span")).setAttribute(
              ...
              (s.style.counterReset = "linenumber " +
