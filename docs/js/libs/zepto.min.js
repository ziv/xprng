  ...
  var e = function () {
    ...
    return N.matches = function (t, e) {
      ...
      r.fn = {
        ...
        ready: function (t) {
          return w.test(f.readyState) && f.body
            ? t(r)
        ...
        val: function (t) {
          return 0 in arguments
            ...
            : this[0] &&
              (this[0].multiple
                ? r(this[0]).find("option").filter(function () {
    ...
    function (e) {
      ...
      h.href = t.location.href,
        ...
        e.ajax = function (n) {
          ...
          if (
            N.open(s.type, s.url, A, s.username, s.password), s.xhrFields
    ...
    function (t) {
      t.fn.serializeArray = function () {
        ...
        return this[0] && t.each(this[0].elements, function (r, o) {
          n = o.type,
            e = o.name,
            e && "fieldset" != o.nodeName.toLowerCase() && !o.disabled &&
            "submit" != n && "reset" != n && "button" != n && "file" != n &&
