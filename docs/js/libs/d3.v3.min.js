...
!function () {
  ...
  function w(n) {
    ...
    return t.on = function (t, i) {
      var u, o = r.get(t);
      return arguments.length < 2 ? o && o.on : (o &&
        (o.on = null,
  ...
  function W(e) {
    var r = ".dragsuppress-" + ++Eo,
      i = "click" + r,
      u = to.select(t(e)).on("touchmove" + r, S).on("dragstart" + r, S).on(
        "selectstart" + r,
        S,
      );
    if (
  ...
  function ln(n, t, e) {
    return this instanceof ln
      ...
      : arguments.length < 2
      ? n instanceof ln ? new ln(n.h, n.s, n.l) : bn("" + n, wn, ln)
      : new ln(n, t, e);
  }
  function cn(n, t, e) {
    function r(n) {
  ...
  function pn(n, t, e) {
    ...
    return i = dn(i) * Zo,
      ...
      u = dn(u) * Xo,
      new mn(
        yn(3.2404542 * i - 1.5371385 * r - .4985314 * u),
        yn(-.969266 * i + 1.8760108 * r + .041556 * u),
        yn(.0556434 * i - .2040259 * r + 1.0572252 * u),
      );
  }
  function gn(n, t, e) {
    return n > 0
  ...
  function yn(n) {
    return Math.round(
      255 * (n <= .00304 ? 12.92 * n : 1.055 * Math.pow(n, 1 / 2.4) - .055),
    );
  }
  function mn(n, t, e) {
    return this instanceof mn
      ...
      : arguments.length < 2
      ? n instanceof mn ? new mn(n.r, n.g, n.b) : bn("" + n, mn, cn)
      : new mn(n, t, e);
  }
  function xn(n) {
  ...
  function bn(n, t, e) {
    ...
    return (u = Wo.get(n))
      ? t(u.r, u.g, u.b)
      : (null == n || "#" !== n.charAt(0) ||
        isNaN(u = parseInt(n.slice(1), 16)) || (4 === n.length
          ? (o = (3840 & u) >> 4,
            o |= o >> 4,
            a = 240 & u,
            a |= a >> 4,
  ...
  function Sn(n, t, e) {
    var r = vn(
        (.4124564 * (n = kn(n)) + .3575761 * (t = kn(t)) +
          .1804375 * (e = kn(e))) / Zo,
      ),
      i = vn((.2126729 * n + .7151522 * t + .072175 * e) / Vo);
    return hn(
      116 * i - 16,
      500 * (r - i),
      200 * (i - vn((.0193339 * n + .119192 * t + .9503041 * e) / Xo)),
    );
  }
  function kn(n) {
  ...
  function Un(n) {
    ...
    return function (n) {
      ...
      return function (n) {
        ...
        return x && (M = u(k + M, k.length ? f - _.length : 1 / 0)),
          i += d,
          n = M + _,
          ("<" === o
            ? i + n + k
  ...
  function In(n) {
    function t(n) {
      ...
      return t.parse = function (t) {
        ...
        var i = null != r.Z && ua !== Hn, u = new (i ? Hn : ua)();
        return "j" in r
  ...
  function jt(n, t) {
    return ((n = n.x)[0] < 0 ? n[1] - Ro - Co : Ro - n[1]) -
    ...
    return so(o) > Co
      ? Math.atan(
        (Math.sin(t) * (u = Math.cos(r)) * Math.sin(e) -
          Math.sin(r) * (i = Math.cos(t)) * Math.sin(n)) / (i * u * o),
      )
      : (t + r) / 2;
  }
  function Ht(n, t, e, r) {
  ...
  function Yt(n) {
    ...
    function r(n, t, e) {
      var r = [1, 0, 0],
        ...
        l = o - a * a;
      if (!l) return !e && n;
      var c = u * o / l, f = -u * a / l, s = mt(r, i), h = Mt(r, c);
      xt(h, Mt(i, f));
      var p = s, g = yt(h, p), d = yt(p, p), v = g * g - d * (yt(h, h) - 1);
      if (!(v < 0)) {
        var y = Math.sqrt(v), m = Mt(p, (-g - y) / d);
        if (xt(m, h), m = bt(m), !e) return m;
        var x, M = n[0], _ = t[0], b = n[1], w = t[1];
        _ < M && (x = M, M = _, _ = x);
        var S = _ - M, k = so(S - Lo) < Co, N = k || S < Co;
        if (
          !k && w < b && (x = b, b = w, w = x),
            N
              ? k
    ...
    var u = Math.cos(n), o = u > 0, a = so(u) > Co;
        ...
        if (u = e - l, h || !(u < 0)) {
          ...
          if (u = t - c, p || !(u > 0)) {
            ...
            if (u = r - c, p || !(u < 0)) {
              ...
              return f > 0 && (i.a = { x: l + f * h, y: c + f * p }),
  ...
  function Zt(n, t, e, r) {
    ...
    return function (a) {
      ...
      function c(u, a, l, c) {
        var f = 0, s = 0;
        if (
          null == u || (f = i(u, l)) !== (s = i(a, l)) || o(u, a) < 0 ^ l > 0
        ) {
          do {
      ...
      var d,
        ...
        C = {
          ...
          polygonEnd: function () {
            a = N, d = to.merge(d);
            var t = l([n, r]), e = k && t, i = d.length;
            (e || i) &&
            (a.polygonStart(),
              e && (a.lineStart(), c(null, null, 1, a), a.lineEnd()),
              i && Lt(d, u, t, c, a),
              a.polygonEnd()), d = v = y = null;
          },
        };
      return C;
    };
  ...
  function ke(n, t) {
    ...
    var r = Math.cos(n),
      ...
      u = r / i + n;
    return so(i) < Co ? ce : (e.invert = function (n, t) {
      var e = u - t;
  ...
  function Je(n, t) {
    ...
    if (d === p) {
      if (v < o || v >= a) return;
      if (h > g) {
        if (u) { if (u.y >= c) return; }
        else u = { x: v, y: l };
        e = { x: v, y: c };
      } else {
        if (u) { if (u.y < l) return; }
        else u = { x: v, y: c };
        e = { x: v, y: l };
      }
      ...
      if (u) { if (u.x >= a) return; }
      else u = { x: o, y: r * o + i };
      e = { x: a, y: r * a + i };
    } else {
      if (u) { if (u.x < o) return; }
      else u = { x: a, y: r * a + i };
      e = { x: o, y: r * o + i };
    }
  ...
  function ar(n, t) {
    ...
    for (Ba = [], Wa = new Array(n.length), Ja = new er(), Ka = new er();;) {
      if (i = Ga, u && (!i || u.y < i.y || u.y === i.y && u.x < i.x)) {
        u.x === e && u.y === r ||
        (Wa[u.i] = new Ie(u), He(u), e = u.x, r = u.y), u = n.pop();
      } else {
        if (!i) break;
        Fe(i.arc);
      }
  ...
  function pr(n, t, e, r, i, u, o) {
    ...
    return function n(c, f, s, h, p) {
      if (!(f > u || s > o || h < r || p < i)) {
        if (g = c.point) {
          var g, d = t - c.x, v = e - c.y, y = d * d + v * v;
          if (y < l) {
            var m = Math.sqrt(l = y);
  ...
  function gr(n, t) {
    ...
    return function (n) {
      return "#" + _n(Math.round(e + u * n)) + _n(Math.round(r + o * n)) +
        _n(Math.round(i + a * n));
    };
  }
  function dr(n, t) {
  ...
  function yr(n, t) {
    var e, r, i, u = el.lastIndex = rl.lastIndex = 0, o = -1, a = [], l = [];
  ...
  function qr(n) {
    return n < 1 / 2.75
      ? 7.5625 * n * n
      : n < 2 / 2.75
      ? 7.5625 * (n -= 1.5 / 2.75) * n + .75
      : n < 2.5 / 2.75
      ? 7.5625 * (n -= 2.25 / 2.75) * n + .9375
  ...
  function Ci(n, t, e) {
    ...
    if (r && (i || u)) {
      var o = t.r + e.r,
        a = i * i + u * u,
        l = .5 + ((r *= r) - (o *= o)) / (2 * a),
        c = Math.sqrt(Math.max(0, 2 * o * (r + a) - (r -= a) * r - o * o)) /
          (2 * a);
  ...
  function Ii(n, t, e, r) {
    function i() {
      var i = Math.min(n.length, t.length) > 2 ? Yi : Fi, l = r ? Br : $r;
  ...
  function Gi(n, t, e, r) {
    function i(n) {
      return (e ? Math.log(n < 0 ? 0 : n) : -Math.log(n > 0 ? 0 : -n)) /
        Math.log(t);
    }
    function u(n) {
  ...
  function hu(n, t, e, r, i) {
    var u = n[0] - t[0],
      ...
      A = S - g,
      C = k - d;
    return N * N + E * E > A * A + C * C && (b = S, w = k),
      [[b - l, w - c], [b * e / x, w * e / x]];
  }
  function pu(n) {
    function t(t) {
    ...
    var e = Ce, r = ze, i = zt, u = gu, o = u.key, a = .7;
  ...
  function bu(n, t) {
    ...
    if (
      ...
      a = t[1],
        u = n[l],
        l++,
        r += "C" + (i[0] + o[0]) + "," + (i[1] + o[1]) + "," + (u[0] - a[0]) +
          "," + (u[1] - a[1]) + "," + u[0] + "," + u[1];
      for (var c = 2; c < t.length; c++, l++) {
        u = n[l],
          a = t[c],
          r += "S" + (u[0] - a[0]) + "," + (u[1] - a[1]) + "," + u[0] + "," +
            u[1];
      }
    }
    if (e) {
      var f = n[l];
      r += "Q" + (u[0] + 2 * a[0] / 3) + "," + (u[1] + 2 * a[1] / 3) + "," +
        f[0] + "," + f[1];
    }
    return r;
  }
  ...
  function qu(n) {
    ...
    for (a = -1; ++a <= l;) {
      i = (n[Math.min(l, a + 1)][0] - n[Math.max(0, a - 1)][0]) /
        (6 * (1 + o[a] * o[a])), u.push([i || 0, o[a] * i || 0]);
    }
    return u;
  }
  function Tu(n) {
  ...
  function Uu(n) {
    return function () {
      var t = n.apply(this, arguments), e = t[0], r = t[1] - Ro;
  ...
  function $u(n, t, e, r, i) {
    ...
    function a(i) {
      ...
      if (u >= 1) {
        return d.event && d.event.end.call(n, n.__data__, t),
          --g.count ? delete g[r] : delete n[e],
          1;
      }
    }
    var l, f, s, h, p, g = n[e] || (n[e] = { active: 0, count: 0 }), d = g[r];
    d ||
      (l = i.time,
        f = qn(u, 0, l),
        d = g[r] = {
  ...
  function Gu(n, t, e) {
    ...
    function i(n, e) {
      var r = (n[1] - n[0]) / e, i = to.bisect(Yl, r);
      return i == Yl.length
        ? [
          t.year,
          Xi(
  ...
  to.ascending = e,
    ...
    to.median = function (n, t) {
      ...
      if (o.length) return to.quantile(o.sort(e), .5);
    },
      ...
      function e(n, t, e, u, o) {
        return function () {
          ...
          var c,
            ...
            d = n(),
            v = ".drag" + (null == d ? "" : "-" + d),
            y = to.select(e(s)).on(u + v, a).on(o + v, l),
            m = W(s),
            x = t(h, d);
          i
            ? (c = i.apply(f, arguments), c = [c.x - x[0], c.y - x[1]])
            : c = [0, 0], p({ type: "dragstart" });
        };
      }
  ...
  to.interpolateZoom = function (n, t) {
    ...
    to.behavior.zoom = function () {
      function n(n) {
        n.on(L, s).on(Fo + ".zoom", p).on("dblclick.zoom", g).on(R, h);
      }
      function e(n) {
      ...
      function a() {
        _ && _.domain(
          M.range().map(function (n) {
            return (n - k.x) / k.k;
          }).map(M.invert),
        ),
          w && w.domain(
            b.range().map(function (n) {
              return (n - k.y) / k.k;
            }).map(b.invert),
          );
      }
      ...
      function p() {
        ...
        m
          ...
          S(),
          i(Math.pow(2, .002 * Uo()) * k.k),
          u(v, d),
          c(n);
      }
      function g() {
        var n = to.mouse(this), t = Math.log(k.k) / Math.LN2;
        o(
          this,
          n,
          e(n),
      ...
      return Fo || (Fo = "onwheel" in io
        ...
        n.event = function (n) {
          n.each(function () {
            ...
            zl
              ? to.select(this).transition().each("start.zoom", function () {
  ...
  Yo.brighter = function (n) {
    ...
    to.lab = hn;
  var Io = 18, Zo = .95047, Vo = 1, Xo = 1.08883, $o = hn.prototype = new an();
  ...
  var Jo,
    ...
    Ko,
    Qo,
    na = this[M(this, "requestAnimationFrame")] || function (n) {
      setTimeout(n, 17);
    };
  to.timer = function () {
  ...
  to.geo.bounds = function () {
    ...
    function t(t, e) {
      var r = vt([t * Do, e * Do]);
      if (y) {
        var i = mt(y, r), u = mt([i[1], -i[0], 0], i);
        _t(u), u = bt(u);
        var o = t - g, l = o > 0 ? 1 : -1, c = u[0] * Po * l, d = so(o) > 180;
        ...
        d
          ? t < g ? a(f, t) > a(f, h) && (h = t) : a(t, h) > a(f, h) && (f = t)
          : h >= f
          ? (t < f && (f = t), t > h && (h = t))
          : t > g
          ? a(f, t) > a(f, h) && (h = t)
    ...
    to.geo.centroid = function (n) {
      ya =
        ...
        Na =
        Ea =
          0, to.geo.stream(n, Aa);
      var t = ka, e = Na, r = Ea, i = t * t + e * e + r * r;
      return i < zo &&
          (t = ba,
            e = wa,
            r = Sa,
  ...
  to.geo.clipExtent = function () {
    ...
    to.geo.albers = function () {
      return to.geo.conicEqualArea().rotate([96, 0]).center([-.6, 38.7])
        .parallels([29.5, 45.5]).scale(1070);
    },
    to.geo.albersUsa = function () {
      ...
      var t,
        ...
        i,
        u = to.geo.albers(),
        o = to.geo.conicEqualArea().rotate([154, 0]).center([-2, 58.5])
          .parallels([55, 65]),
        a = to.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9])
          .parallels([8, 18]),
        l = {
          point: function (n, e) {
            t = [n, e];
      ...
      return n.invert = function (n) {
        ...
        n.translate = function (t) {
          ...
          return e = u.translate(t).clipExtent([[f - .455 * c, s - .238 * c], [
            f + .455 * c,
            s + .238 * c,
          ]]).stream(l).point,
            r = o.translate([f - .307 * c, s + .201 * c]).clipExtent([[
              f - .425 * c + Co,
              s + .12 * c + Co,
            ], [f - .214 * c - Co, s + .234 * c - Co]]).stream(l).point,
            i = a.translate([f - .205 * c, s + .212 * c]).clipExtent([[
              f - .214 * c + Co,
              s + .166 * c + Co,
            ], [f - .115 * c - Co, s + .234 * c - Co]]).stream(l).point,
            n;
        },
        n.scale(1070);
    };
  ...
  to.geo.path = function () {
    ...
    to.geo.rotation = function (n) {
      ...
      return n = se(n[0] % 360 * Do, n[1] * Do, n.length > 2 ? n[2] * Do : 0),
        t.invert = function (t) {
    ...
    to.geo.graticule = function () {
      ...
      function t() {
        return to.range(Math.ceil(u / v) * v, i, v).map(h).concat(
          to.range(Math.ceil(c / y) * y, l, y).map(p),
        ).concat(
          to.range(Math.ceil(r / g) * g, e, g).filter(function (n) {
            return so(n % v) > Co;
          }).map(f),
        ).concat(
          to.range(Math.ceil(a / d) * d, o, d).filter(function (n) {
            return so(n % y) > Co;
          }).map(s),
        );
      }
      ...
      return n.lines = function () {
        ...
        n.majorExtent([[-180, -90 + Co], [180, 90 - Co]]).minorExtent([[
          -180,
          -80 - Co,
        ], [180, 80 + Co]]);
    },
      ...
      for (
        ...
        for (
          ...
          Te(o = t[e], f, i)
            ...
            : Te(u, f, i) && n.push(Re(u, o, f, i)), u = o;
        }
        a && n.push(n[0]), f = i;
      }
      return n;
    };
  var Ba, Wa, Ja, Ga, Ka, Qa = [], nl = [];
  ...
  to.geom.delaunay = function (n) {
    ...
    to.geom.quadtree = function (n, t, e, r, i) {
      function u(n) {
        function u(n, t, e, r, i, u, o, a) {
          if (!isNaN(e) && !isNaN(r)) {
            if (n.leaf) {
              var l = n.x, f = n.y;
              if (null != l) {
                if (so(l - e) + so(f - r) < .01) c(n, t, e, r, i, u, o, a);
                else {
                  var s = n.point;
        ...
        var f, s, h, p, g, d, v, y, m, x = En(a), M = En(l);
  ...
  to.interpolate = mr,
    to.interpolators = [function (n, t) {
      var e = typeof t;
      return ("string" === e
        ? Wo.has(t.toLowerCase()) || /^(#|rgb\(|hsl\()/i.test(t) ? gr : yr
        : t instanceof an
        ? gr
        : Array.isArray(t)
        ? xr
  ...
  to.interpolateTransform = Xr,
    ...
    to.layout.chord = function () {
      function n() {
        var n, c, s, h, p, g = {}, d = [], v = to.range(u), y = [];
        for (e = [], r = [], n = 0, h = -1; ++h < u;) {
          for (c = 0, p = -1; ++p < u;) c += i[h][p];
          d.push(c), y.push(to.range(u)), n += c;
        }
        for (
          o && v.sort(function (n, t) {
            return o(d[n], d[t]);
          }),
          ...
          for (s = c, p = -1; ++p < u;) {
            var m = v[h], x = y[m][p], M = i[m][x], _ = c, b = c += M * n;
            g[m + "-" + x] = {
              index: m,
              subindex: x,
              startAngle: _,
    ...
    to.layout.force = function () {
      ...
      return l.tick = function () {
        ...
        var t, r, l, h, p, d, y, m, _, b = x.length, w = M.length;
        for (r = 0; r < w; ++r) {
          h = (l = M[r]).source,
            (d = (m = (p = l.target).x - h.x) * m + (_ = p.y - h.y) * _) &&
            (m *= d = i * o[r] * ((d = Math.sqrt(d)) - u[r]) / d,
              _ *= d,
              p.x -= m * (y = h.weight + p.weight
        ...
        l.start = function () {
          ...
          var t, e, r, i = x.length, c = M.length, s = f[0], d = f[1];
        ...
        l.drag = function () {
          if (
            r ||
            (r = to.behavior.drag().origin(m).on("dragstart.force", Kr).on(
              "drag.force",
              t,
            ).on("dragend.force", Qr)), !arguments.length
          ) return r;
          this.on("mouseover.force", ni).on("mouseout.force", ti).call(r);
        },
        to.rebind(l, c, "on");
    };
  var ll = 20, cl = 1, fl = 1 / 0;
  to.layout.hierarchy = function () {
    ...
    to.layout.partition = function () {
      function n(t, e, r, i) {
        var u = t.children;
        if (
          t.x = e, t.y = t.depth * i, t.dx = r, t.dy = i, u && (o = u.length)
        ) {
          var o, a, l, c = -1;
      ...
      var r = to.layout.hierarchy(), i = [1, 1];
    ...
    to.layout.pie = function () {
      ...
      var t = Number, e = sl, r = 0, i = qo, u = 0;
  ...
  to.layout.stack = function () {
    function n(a, l) {
      ...
      var h, p, g, d, v = r.call(n, f, l), y = c[0].length;
      for (g = 0; g < y; ++g) {
    ...
    var t = m, e = pi, r = gi, i = hi, u = fi, o = si;
  ...
  to.layout.histogram = function () {
    ...
    to.layout.pack = function () {
      ...
      var t, e = to.layout.hierarchy().sort(_i), r = 0, i = [1, 1];
    ...
    to.layout.tree = function () {
      ...
      function r(n) {
        var t, e = n.t.y + n.y_size, i = n.t.depth + 1;
      ...
      function o(n, t, e) {
        for (
          ...
          null != _
            ...
            p > 0
              ? (o += p, a(n, t, e.index, p))
              : 1 === t && 0 === o && 0 === r.num_children &&
                u.num_children > 1 && p < 0 && (o += p, a(n, t, e.index, p));
          var g = f(r), d = f(u);
      ...
      function p(n) {
        n.prelim =
          (n.children[0].prelim + n.children[0].mod - n.children[0].x_size / 2 +
            n.children[n.num_children - 1].mod +
            n.children[n.num_children - 1].prelim +
            n.children[n.num_children - 1].x_size / 2) / 2;
      }
      function g(n, t) {
    ...
    to.layout.cluster = function () {
      function n(n, u) {
        ...
        var f = Ti(l), s = Ri(l), h = f.x - e(f, s) / 2, p = s.x + e(s, f) / 2;
        return ui(
          l,
          i
            ? function (n) {
  ...
  to.scale.quantile = function () {
    ...
    to.svg.arc = function () {
      function n() {
        ...
        if (
          h > Co &&
          (g = Math.min(Math.abs(c - n) / 2, +i.apply(this, arguments))) > .001
        ) {
          d = n < c ^ p ? 0 : 1;
          var T = g, R = g;
          if (h < Lo) {
      ...
      var e = ou, r = au, i = uu, u = bl, o = lu, a = cu, l = fu;
      return n.innerRadius = function (t) {
        ...
        n.centroid = function () {
          var n = (+e.apply(this, arguments) + +r.apply(this, arguments)) / 2,
            t = (+o.apply(this, arguments) + +a.apply(this, arguments)) / 2 -
              Ro;
  ...
  to.svg.line.radial = function () {
    ...
    to.svg.chord = function () {
      function n(n, a) {
        ...
        return "M" + l.p0 + r(l.r, l.p1, l.a1 - l.a0) + (e(l, c)
          ? i(l.r, l.p1, l.r, l.p0)
          : i(l.r, l.p1, c.r, c.p0) + r(c.r, c.p1, c.a1 - c.a0) +
            i(c.r, c.p1, l.r, l.p0)) +
          "Z";
      }
      function t(n, t, e, r) {
    ...
    to.svg.diagonal.radial = function () {
      var n = to.svg.diagonal(), t = ju, e = n.projection;
  ...
  var Al = Math.sqrt(3), Cl = Math.tan(30 * Do);
  ...
  Tl.call = _o.call,
    ...
    Tl.tween = function (n, t) {
      ...
      return arguments.length < 2 ? this.node()[r][e].tween.get(n) : I(
        this,
        null == t
          ? function (t) {
    ...
    Tl.attr = function (n, t) {
      ...
      var o = "transform" == n ? Xr : mr, a = to.ns.qualify(n);
    ...
    Tl.delay = function (n) {
      var t = this.id, e = this.namespace;
      return arguments.length < 1 ? this.node()[e][t].delay : I(
        this,
        "function" == typeof n
          ? function (r, i, u) {
    ...
    Tl.duration = function (n) {
      var t = this.id, e = this.namespace;
      return arguments.length < 1 ? this.node()[e][t].duration : I(
        this,
        "function" == typeof n
          ? function (r, i, u) {
      ...
      function n(n) {
        n.each(function () {
          var n,
            ...
            d = g.enter().insert("g", ".domain").attr("class", "tick").style(
              "opacity",
              Co,
            ),
  ...
  var Dl = "bottom", Pl = { top: 1, right: 1, bottom: 1, left: 1 };
  to.svg.brush = function () {
    function n(t) {
      t.each(function () {
        var t = to.select(this).style("pointer-events", "all").style(
            "-webkit-tap-highlight-color",
            "rgba(0,0,0,0)",
          ).on("mousedown.brush", u).on("touchstart.brush", u),
          o = t.selectAll(".background").data([0]);
        o.enter().append("rect").attr("class", "background").style(
          "visibility",
          "hidden",
        ).style("cursor", "crosshair"),
          t.selectAll(".extent").data([0]).enter().append("rect").attr(
            "class",
            "extent",
          ).style("cursor", "move");
        ...
        var l, s = to.transition(t), h = to.transition(o);
    ...
    function u() {
      ...
      function d() {
        32 == to.event.keyCode && 2 == C &&
          (L[0] += s[1], L[1] += h[1], C = 0, S());
      }
      function v() {
        var n = to.mouse(_), t = !1;
        M && (n[0] += M[0], n[1] += M[1]),
          C ||
          (to.event.altKey
      ...
      function m() {
        v(),
          k.style("pointer-events", "all").selectAll(".resize").style(
            "display",
            n.empty() ? "none" : null,
          ),
          to.select("body").style("cursor", null),
          q.on("mousemove.brush", null).on("mouseup.brush", null).on(
            "touchmove.brush",
            null,
          ).on("touchend.brush", null).on("keydown.brush", null).on(
            "keyup.brush",
            null,
          ),
          z(),
      ...
      k.style("pointer-events", "none").selectAll(".resize").style(
        "display",
        null,
      ),
    ...
    return n.event = function (n) {
      n.each(function () {
        ...
        this.__chart__ = t,
          zl
            ? to.select(this).transition().each("start.brush", function () {
  ...
  Fl.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z")
    ? Ju
    : Ol,
    Ju.parse = function (n) {
      var t = new Date(n);
