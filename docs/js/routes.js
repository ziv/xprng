document.addEventListener("DOMContentLoaded", function () {
  ...
  infos_group
    ...
    .html(function (d) {
      ...
      if (d.kind === "module") {
        if (d.module) {
          _name += '<tspan x="0" dy="1.4em"><a href="./modules/' +
            d.module +
            '.html">' +
            d.module +
            "</a></tspan>";
          ...
          _name += '<tspan x="0" dy="1.4em">' + htmlEntities(d.name) +
            "</tspan>";
        }
      } else if (d.kind === "component") {
        _name += '<tspan x="0" dy="1.4em">' + d.path + "</tspan>";
        _name += '<tspan x="0" dy="1.4em"><a href="./components/' +
          d.component +
          '.html">' +
          d.component +
          "</a></tspan>";
        if (d.outlet) {
          _name += '<tspan x="0" dy="1.4em">&lt;outlet&gt; : ' + d.outlet +
            "</tspan>";
        }
      } else {
        _name += '<tspan x="0" dy="1.4em">/' + d.path + "</tspan>";
        ...
        if (d.redirectTo) {
          _name += '<tspan x="0" dy="1.4em">&rarr; ' + d.redirectTo +
            "</tspan>";
        }
        if (d.pathMatch) {
